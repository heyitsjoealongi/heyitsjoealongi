export default function Home() {
  return (
    <section>
      ...
      <h3 className="my-9 lg:my-18 max-w-xl mx-auto text-xl lg:text-3xl font-light subpixel-antialiased">
        Advising on resilience, engineering security, and shaping what’s next.
      </h3>
      <p className="my-3 lg:my-6 text-md lg:text-lg font-extralight subpixel-antialiased">
